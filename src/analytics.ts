 ...
 */
const handleUnstructuredEvent = (event: { action: string; label: string; value?: string; property?: string }) => {
 ...
 *
 */
export const track = async (name: string, label: string) => {
